...
\usepackage[utf8]{inputenc} % remove if you want to use XeTeX
...
\vglue 1 true cm
\begin{flushright}
\includegraphics[width=5cm]{logo_fsferm_plain}
...
Freien Software-Lizenzen und der \frqq Freien Software Bewegung\flqq 
...
\textbf{Impressum:} \ 
Guido Arnold\ | \ Obergasse 8\ |  61118 \ Bad Vilbel\\
\url{https://wiki.fsfe.org/LocalGroups/RheinMain}
}
} % End Backpage
